...
lv_obj_set_y( ui_Label_HH, -55 );
lv_obj_set_align( ui_Label_HH, LV_ALIGN_CENTER );
lv_label_set_text(ui_Label_HH,"10");
...
lv_obj_set_y( ui_Label_Colon, 53 );
...
lv_obj_set_y( ui_Label_MM, 60 );
lv_obj_set_align( ui_Label_MM, LV_ALIGN_CENTER );
lv_label_set_text(ui_Label_MM,"09");
...
lv_label_set_text(ui_Label_Abbr,"AM");
